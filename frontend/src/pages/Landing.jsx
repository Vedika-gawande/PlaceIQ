...
import { Zap, GitBranch, Building2, BrainCircuit, ArrowRight, Code2, Map, BarChart2 } from 'lucide-react';
export default function Landing() {
  const navigate = useNavigate();

  const features = [
    { icon: <Zap size={18} />,          title: 'Resume Parser',       desc: 'Extracts skills, CGPA and email from your PDF instantly' },
    { icon: <GitBranch size={18} />,     title: 'GitHub Analyzer',    desc: 'Calculates your GitHub power score from repos and languages' },
